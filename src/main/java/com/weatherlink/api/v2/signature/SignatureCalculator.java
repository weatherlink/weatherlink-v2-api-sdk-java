...
public class SignatureCalculator {
    ...
    /**
     * Compute the API Signature for an API call to <code>/stations</code> given the specific
     * parameters
     *
    ...
    /**
     * Compute the API Signature for an API call to <code>/stations/{station-ids}</code> given the
     * specific parameters
     *
     * @param apiKey the API Key
     * @param apiSecret the API Secret
    ...
    /**
     * Compute the API Signature for an API call to <code>/nodes</code> given the specific
     * parameters
     *
     * @param apiKey the API Key
     * @param apiSecret the API Secret
     ...
     * @throws SignatureException if there is a problem utilizing the HmacSHA256 algorithm
     */
    public String calculateNodesSignature(String apiKey, String apiSecret, long apiRequestTimestamp)
            throws SignatureException {
    ...
    /**
     * Compute the API Signature for an API call to <code>/nodes/{node-ids}</code> given the
     * specific parameters
     *
     * @param apiKey the API Key
     * @param apiSecret the API Secret
    ...
    /**
     * Compute the API Signature for an API call to <code>/sensors</code> given the specific
     * parameters
     *
     * @param apiKey the API Key
     * @param apiSecret the API Secret
    ...
    /**
     * Compute the API Signature for an API call to <code>/sensors/{sensor-ids}</code> given the
     * specific parameters
     *
     * @param apiKey the API Key
     * @param apiSecret the API Secret
    ...
    /**
     * Compute the API Signature for an API call to <code>/sensor-activity</code> given the specific
     * parameters
     *
     * @param apiKey the API Key
     * @param apiSecret the API Secret
    ...
    /**
     * Compute the API Signature for an API call to <code>/sensor-activity/{sensor-ids}</code> given
    ...
    /**
     * Compute the API Signature for an API call to <code>/sensor-catalog</code> given the specific
     * parameters
     *
     * @param apiKey the API Key
     * @param apiSecret the API Secret
    ...
    /**
     * Compute the API Signature for an API call to <code>/current/{station-id}</code> given the
     * specific parameters
     *
     * @param apiKey the API Key
     * @param apiSecret the API Secret
    ...
    public String calculateCurrentSignature(
            String apiKey, String apiSecret, long apiRequestTimestamp, int stationId)
            throws SignatureException {
    ...
    /**
     * Compute the API Signature for an API call to <code>/historic/{station-id}</code> given the
     * specific parameters
     *
     * @param apiKey the API Key
     * @param apiSecret the API Secret
     * @param apiRequestTimestamp the Unix timestamp for when the API request is being made
     * @param stationId the station ID
     * @param startTimestamp the Unix timestamp marking the beginning of the time window for the
     *     data requested
     * @param endTimestamp the Unix timestamp marking the end of the time window for the data
     *     requested
     * @return the API Signature
     * @throws SignatureException if there is a problem utilizing the HmacSHA256 algorithm
     */
    ...
    private String calculateSignature(String apiSecret, Map<String, String> parametersToHash)
        ...
        try {
            ...
            throw new SignatureException(
                    "MAC Algorithm " + MAC_ALGORITHM + " secret key is invalid");
        }
