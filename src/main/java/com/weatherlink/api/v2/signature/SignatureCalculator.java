...
public class SignatureCalculator {
  ...
  /**
   * Compute the API Signature for an API call to <code>/nodes/{node-ids}</code> given the specific
   * parameters
   *
   * @param apiKey the API Key
   * @param apiSecret the API Secret
   ...
   * @throws SignatureException if there is a problem utilizing the HmacSHA256 algorithm
   */
  public String calculateSensorsSignature(String apiKey, String apiSecret, long apiRequestTimestamp)
      throws SignatureException {
   ...
   * @param apiRequestTimestamp the Unix timestamp for when the API request is being made
   * @param stationId the station ID
   * @param startTimestamp the Unix timestamp marking the beginning of the time window for the data
   *     requested
